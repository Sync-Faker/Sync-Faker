...
if __name__ == "__main__":
    # 设置路径
    root_dir = "/mnt/localDisk2/ssk-dataset/semantic-kitti-fov/dataset" # 数据集根目录
    prediction_root_dir = "/mnt/localDisk2/ssk/PMF-master/experiments/PMF-SemanticKitti-log-noAttack/Eval-SemanticKitti-PMFNet-SemanticKITTI-PMF-ResNet34-noKNN-debug_timestamp/preds"
    attack_prediction_root_dir = "/mnt/localDisk2/ssk/PMF-master/experiments/PMF-SemanticKitti-log-Attack/Eval-SemanticKitti-PMFNet-SemanticKITTI-PMF-ResNet34-noKNN-debug_timestamp/preds"
