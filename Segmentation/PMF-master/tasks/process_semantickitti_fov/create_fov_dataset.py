...
if __name__ == "__main__":
    ...
    #     createFovDataset(
    #         src_root=".../SemanticKITTI/dataset/sequences", # path to the original semantic-kitti dataset
    #         dst_root=".../semantic-kitti-fov/dataset/sequences", # path to the generated semantic-kitti-fov dataset
    #         seq=seq
    #     )
    createFovDataset(
            src_root="", # path to the original semantic-kitti dataset
            dst_root="", # path to the generated semantic-kitti-fov dataset
            seq=8
        )